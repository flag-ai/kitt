...
//
// Later PRs will add service fields (BonnieRegistry, EngineRegistry,
// BenchmarkRegistry, CampaignRunner, Storage, Notifier, Recommender)
// as each layer lands.
...
func NewRouter(cfg *RouterConfig) *chi.Mux {
	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		// Domain routes land here in PRs B–H.
	})
